...
const Navbar = () => {
  ...
  const nav = (
    <>
      ...
      <li className="flex">
        <NavLink to="/about" className="flex items-center px-4 -mb-1 border-b-2 border-transparent">
          About
        </NavLink>
      </li>
      <li className="flex">
      ...
      <li className="flex">
        <NavLink to="/blogs" className="flex items-center px-4 -mb-1 border-b-2 border-transparent">
          Blogs
        </NavLink>
      </li>
    </>
